...
describe('Course Component', () => {
  const mockCourse: Partial<CourseType> = {
    ...
    title: 'MATHEMATICS 2',
    description:
      'Partial differentiation. Multiple integrals. Sequences and series. First order differential equations. Second order differential equations.',
    school: 'SPMS',
    likes: 0,
    watchlists: 2,
    color: '#FFFF00',
  ...
  it('renders the Course component with correct data', () => {
    ...
    expect(
      screen.getByText(mockCourse.watchlists!.toString()),
    ).toBeInTheDocument()
  })
