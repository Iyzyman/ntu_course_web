...
export const AllReviews = () => {
    ...
    return (
        <Stack spacing={2}>
            <Typography sx={{ borderBottom: 2, borderColor: '#A3A3A3' }}>All Reviews</Typography>
            {reviews.map((review) => (
                <Box py={2} px={4} sx={{ border: 1, borderRadius: 1 }}>
                    ...
                    {review.recommended && (
                        <Stack spacing={2} direction='row' py={2}>
                            <ThumbUpOutlinedIcon /><Typography>{review.author} recommends this course</Typography>
                        </Stack>
                    )}
                </Box>
            ))}
...
export const ReviewForm = () => {
    ...
    return (
        <Stack spacing={2} py={4}>
            <Typography sx={{ borderBottom: 2, borderColor: '#A3A3A3' }}>Leave your Review</Typography>
            <div>
            ...
            <div>
                ...
                <ToggleButtonGroup exclusive onChange={handleRecommendChange} value={recommend}>
            ...
            <TextField onChange={handleReviewTextChamge} value={reviewText} label='Leave your review here' />
